...
public class MoneyModule extends SimpleModule {
	...
	private static final long serialVersionUID = 752058465011939054L;

	class MoneyDeserializer extends StdScalarDeserializer<Money> {

		private static final long serialVersionUID = 927076149842146328L;
	...
	class MoneySerializer extends StdScalarSerializer<Money> {
		...
		private static final long serialVersionUID = 7570977097346052235L;
